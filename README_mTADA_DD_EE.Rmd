...
We demonstrate how to choose top proritized genes from $\texttt{mTADA}$'s results using a PP threshold of 0.8. These genes can be shared genes, specific genes; or genes for single traits.
